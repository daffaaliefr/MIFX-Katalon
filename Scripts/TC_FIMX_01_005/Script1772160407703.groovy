...
WebUI.setEncryptedText(findTestObject('Page_Swag Labs/input_Password'), 'endzE0GgwlvlmfzYMmQ4jw==')

WebUI.click(findTestObject('Page_Swag Labs/input_login-button'))

WebUI.waitForElementPresent(findTestObject('Page_Swag Labs/div_Epic sadface Username is required'), 0)

WebUI.verifyElementText(findTestObject('Page_Swag Labs/div_Epic sadface Username is required'), 'Epic sadface: Username is required')
