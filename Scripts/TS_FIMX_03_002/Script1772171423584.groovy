...
WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/button_continue-shopping'), 0)

WebUI.verifyElementClickable(findTestObject('Page_Swag Labs/button_checkout'))
