...
WebUI.waitForElementPresent(findTestObject('Page_Swag Labs/div_Epic sadface Password is required'), 0)

WebUI.verifyElementText(findTestObject('Page_Swag Labs/div_Epic sadface Password is required'), 'Epic sadface: Password is required')
