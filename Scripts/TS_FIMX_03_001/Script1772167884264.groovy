...
WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/div_Sauce Labs Backpackcarry.allTheThings() with'), 0)

WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/Description Sauce Labs Backpack'), 0)

WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/Price Sauce Labs Backpack'), 0)

WebUI.verifyElementClickable(findTestObject('Page_Swag Labs/div_Sauce Labs Backpack'))
...
WebUI.verifyElementText(findTestObject('Page_Swag Labs/button_back-to-products'), 'Back to products')
