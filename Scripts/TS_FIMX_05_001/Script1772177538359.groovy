...
WebUI.click(findTestObject('Page_Swag Labs/a_inventory_sidebar_link'))

WebUI.click(findTestObject('Page_Swag Labs/button_react-burger-menu-btn'))

WebUI.click(findTestObject('Page_Swag Labs/a_about_sidebar_link'))

WebUI.verifyMatch(WebUI.getUrl(), 'https://saucelabs.com/', false)
